...
class bishino (Exchange):
    ...
    async def fetch_markets(self, params={}):
        response = await self.publicGetPairs(self.extend({}, params))
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        id = market['id']
        response = await self.publicGetTicker(self.extend({}, params))
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await self.privateGetOfferById(self.extend(request, params))
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.privateGetOffersByAccount(self.extend(request, params))
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.privateGetActiveOffersByAccount(self.extend(request, params))
        return self.parse_orders(response['result'], market, since, limit)
    ...
    async def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.privateGetCompletedOffersByAccount(self.extend(request, params))
        return self.parse_orders(response['result'], market, since, limit)
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if since is not None:
            request['start'] = since
        response = await self.privateGetTradesByAccount(self.extend(request, params))
    ...
    async def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        response = await self.privatePostAuthWithdraw(self.extend(request, params))
        return {
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        await self.load_markets()
        response = await self.privatePostAuthCancel(self.extend({
            'id': id,
        }, params))
        return self.parse_order(response['result'])
